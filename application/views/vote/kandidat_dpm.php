										...
										<div class="card-body  text-center">
											...
											<div class="text-center">
												...
												<div class="row"> 
													...
													<div class="col-12"><button href="<?php echo base_url('admin/profile_kandidat/').$kandidat_dpm['nim'] ?>" id='Profile' class="btn btn-block btn-raised btn-primary mb-3">Lihat Profile</button></div>
